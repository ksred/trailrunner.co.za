	        ...
	        <div class="columns-1 grid">
		        <div class="column">
			        <div class="obox-help-buttons">
				        <a target="blank" href="http://cdn.obox-design.com/<?php echo $themeid; ?>.xml" class="demo-content"><span>Demo Content</span></a>
				        <a target="blank" href="http://kb.oboxsites.com/themedoc-category/<?php echo $themeid; ?>-docs/" class="documentation" target="_blank"><span>Documentation</span></a>
				        <a target="blank" href="http://obox-design.com/forum_list.cfm" class="support-forums" target="_blank"><span>Suppot Forums</span></a>
			        </div>
         ...
         ?>
			<div class="section">
	            ...
	            <div class="instructions">
	                ...
	                <p class="instruction-intro">At the top of the page you will find a yellow ribbon containing a handy “Click Here” link, which will display the recommended widget setup if you get lost.</p>
	                <ul class="instruction-list">
	                    <li><a href="<?php echo admin_url('widgets.php'); ?>" target="blank">Go to the Appearance → Widgets page</a></li>
	                    <li>View the Recommended Widget Layout</li>
	                    <li><a href="http://kb.oboxsites.com/<?php echo $themeid; ?>-setup-widgets" target="blank">Read our documentation on each widget for detailed information</a></li>
	                </ul>
	            </div> 
	            <p class="clearfix"><a href="?page=obox-help&tab=step3" class="next-step step2">Next Step &rarr;</a></p> 
