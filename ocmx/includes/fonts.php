...
function ocmx_load_font_options(){
	...
	$theme_options["font_options"] = array("elements" =>
			array(
				...
				array("label" => "Post Meta", "description" => "", "name" => "ocmx_post_meta_font", "default" => "", "id" => "ocmx_post_meta_font", "input_type" => "font", "elements" => ".date, h5.date, .date a, #post-title-block h5.date, .post-meta, .logged-in-as, .footer-text, .portfolio-category"),
				array("label" => "Post Titles", "description" => "", "name" => "ocmx_post_titles_font", "default" => "", "id" => "ocmx_post_titles_font", "input_type" => "font", "elements" => ".post-title, .post-title a, .portfolio-title-block .post-title, .page-title"),
				array("label" => "Post Copy", "description" => "", "name" => "ocmx_post_copy_font", "default" => "", "id" => "ocmx_post_copy_font", "input_type" => "font", "elements" => ".copy, .one-column .copy p"),
				array("label" => "Widget Titles", "description" => "", "name" => "ocmx_widget_titles_font", "default" => "", "id" => "ocmx_widget_titles_font", "input_type" => "font", "elements" => "#right-column .widgettitle, .widgettitle, .widgettitle a, .section-title, .section-title a, h3#reply-title"),
				array("label" => "Footer Widget Titles", "description" => "", "name" => "ocmx_widget_footer_titles_font", "default" => "", "id" => "ocmx_widget_footer_titles_font", "input_type" => "font", "elements" => ".footer-widgets .widgettitle, #footer h4, .footer-three-column .column h4 a")
			)
		);
	if(!isset($style))
		$style = "";
...
function ocmx_font_script (){
	...
	endforeach;
	wp_enqueue_style( "colorpicker-css",  get_template_directory_uri()."/ocmx/colorpicker.css");
	wp_enqueue_style( "slider-css",  get_template_directory_uri()."/ocmx/slider/jquery-ui.css");
	wp_enqueue_script( "jquery-fonts", get_template_directory_uri()."/scripts/fonts.js", array('jquery', 'jquery-ui-core'));
	wp_enqueue_script( "jquery-colorpicker",  get_template_directory_uri()."/scripts/colorpicker.js", array( "jquery" ) );
