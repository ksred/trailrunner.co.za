...
?>
    <ul class="portfolio-list">
        <?php foreach ($table_Details as $gallery_list) :
			$large_image = site_url()."/wp-content/uploads/ocmx-gallery/large/".$gallery_list->Image;
			$this_image = site_url()."/wp-content/uploads/ocmx-gallery/small/".$gallery_list->Image; ?>
			<li>
				<a href="<?php echo $large_image; ?>" rel="lightbox" class="portfolio-image">
					<span><img src="<?php echo get_template_directory_uri(); ?>/functions/timthumb.php?src=<?php echo $this_image; ?>&amp;h=100&amp;w=205&amp;zc=1" border="0" alt="<?php echo $gallery_list->Item; ?>" /></span>
				</a>
