...
class ocmx_twitter_widget extends WP_Widget {
    ...
    function ocmx_twitter_widget() {
        parent::WP_Widget(false, $name = __('(Obox) Twitter Widget', 'ocmx'), $widget_options = __('Display your latest Tweets.','ocmx'));	
    }
    ...
    function widget($args, $instance) {		
		...
		if(isset($instance["twitter_count"]))
       	 $twitter_count = $instance["twitter_count"];
		if(isset($instance["twitter_replies"]))
			$twitter_replies = $instance["twitter_replies"];
		if(isset($instance["twitter_theme"]))
			$twitter_theme = $instance["twitter_theme"];
		if(isset($instance["twitter_height"]))
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
    ...
    function form($instance) {				
        $defaults = array( 'title' => '', 'twitter_id' => '', 'twitter_count' => '', 'twitter_height' => '300', 'twitter_replies' => true, 'twitter_links' => '#555', 'twitter_theme' => 'light'); 
